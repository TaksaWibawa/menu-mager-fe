...
const schema = yup.object().shape({
  name: yup.string().required('Preference name is required'),
  photo: yup.mixed().test('isFile', 'Preference photo is required', (value) => value instanceof File),
});

export function PreferenceForm({ modalId, onSubmit, status, initialData }) {
  const {
    handleSubmit,
    control,
    formState: { errors },
